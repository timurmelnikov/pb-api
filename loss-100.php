...
curl_setopt($curl, CURLOPT_POSTFIELDS, '{
    "opCode": "waitInfo",
    "request": {
        "req_ID": "Z182QPB7000050"
    },
    "actionLst": [
        {
            "ria_Type": "b",
            "ria_Comment": "Технічний паспорт на застраховане майно.;Довідка з компетентних органів (ЖЕКу/ОСББ/ МЧС і т.д.);Кошторис на відновлення майна, калькуляцію збитків.;Довідку із метеорологічної або сейсмологічної служби.",
	        "ria_DatE": "2018-05-10T23:59:59.000"
        }
    ]
}');
