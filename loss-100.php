...
curl_setopt($curl, CURLOPT_POSTFIELDS, '{
    "opCode": "waitInfo",
    "request": {
        "req_ID": "Z182JPB700002T"
    },
    "actionLst": [
        {
            "ria_Type": "b",
            "ria_Comment": "Паспорт та ІПН код страхувальника та/або власника майна.;Кошторис на відновлення майна, калькуляцію збитків.;Детальне пояснення, як трапилась подія, коли помітили подію, які дії відразу були виконані, для зменшення збитків та які компетентні органи були повідомлені.",
	        "ria_DatE": "2018-04-13T23:59:59.000"
        }
    ]
}');
