...
{"LossDocumentID":835167,   								/* При обновлении передавать полученный ИД КИС убытка */
"IdDocState": 1, 											/* ИД статуса убытка в КИС. Создаем и Обновляем всегда в статусе 1 - Сбор документов */
"IdTypeNews": 68			/* ВАЖНО!!!!Для убытков ИМ-ВО (NBR) передавать ид = 68. Для убытков ЗНБ (HI) передавать ид = 69*/
